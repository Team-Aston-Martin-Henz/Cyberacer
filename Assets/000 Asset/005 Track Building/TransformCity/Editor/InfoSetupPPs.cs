...
public class InfoSetupPPs : EditorWindow
{
    ...
    static void Update()
    {
        ...
        if (showdialogwindow)
        {
            ...
            dialogwindow.minSize = new Vector2(430, 650);
        }
        EditorApplication.update -= Update;
    }
    ...
    public void OnGUI()
    {
        ...
        EditorGUILayout.HelpBox("1. Sometimes: restart editor is required (red errors)", MessageType.None);
        EditorGUILayout.HelpBox("2. Sometimes: remove Post Process layer from camera and add new one again", MessageType.None);
