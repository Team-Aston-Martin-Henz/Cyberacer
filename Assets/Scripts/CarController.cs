...
public class CarController : MonoBehaviour
{
    ...
    void Update()
    {
        // do not update the fram if we are in countdown
        ...
        else
        {
            ...
            aiSpeedInput = Mathf.MoveTowards(aiSpeedInput, finalSpeed, aiAccelerateSpeed);
    ...
    {
        // do not update the lap if car is an AI
        if (isAI)
        {
            return;
        }
